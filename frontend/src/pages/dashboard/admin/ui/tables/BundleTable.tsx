            ...
            <ScrollArea>
                ...
                >
                    ...
                    <Table.Tbody>
                        {bundles.length > 0 ? (
                            bundles.map((bundle) => {
                                // The backend resolves VENUE rules to a venue name; ruleValue is the
                                // raw id there, so it's only the fallback for a stale reference.
                                const ruleLabel =
                                    (locale === "fr" ? bundle.ruleValueLabelFr : bundle.ruleValueLabelEn) ??
                                    bundle.ruleValue;
